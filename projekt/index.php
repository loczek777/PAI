...
<a href="promo.php?page=promo"> Promocje ! </a>
...
<a href="inne.php?page=inne"> Wszystkie gadgety </a>
	...
	<section id="header">
	<ul>
		<li class="p1"><a href="ty">Moje konto</a></li>
		<li class="p1"><a href="gadget">Wyszukaj gadget</a> </li>
		<li class="p1"><a href="my">O nas</a></li>
		<li class="p1" style="float:right"><a href="konto">Login/Rejestracja</a></li>
	</ul>
	</section>
	<section id="body">
	...
	<div id="zd1"><img src="zd1.jpg" width="200" height="200"> </div>
	<div id="zd2"><img src="zd2.jpg" width="200" height="200"> </div>
	<div id="zd3"><img src="zd3.jpg" width="200" height="200"> </div>
	
	</div>
	
	<div id="kwadraty2">
	<div id="zd4"><img src="zd4.jpg" width="200" height="200"> </div>
	<div id="zd5"><img src="zd5.jpg" width="200" height="200"> </div>
	<div id="zd6"><img src="zd6.jpg" width="200" height="200"> </div>
